...
import Almighytyascension_img from '../images/photos/Almightyascension_img.jpg'
import Beyondstengthpctp_img from '../images/photos/Beyondstrengthpctp_img.jpg'
...
export default function Home() {
  const socialLinks = [
    {
      href: 'https://www.instagram.com/jmicufit/',
      icon: InstagramIcon,
    },
  ]
  ...
  const linksData = [
    {
      title: 'almightyascension',
      description: '',
      href: 'https://www.instagram.com/almightyascension/',
      image: Almighytyascension_img,
      icon: null,
    },
    {
      title: 'beyondstrengthpctp',
      description: '',
       href: 'https://www.instagram.com/beyondstrengthpctp/',
      image: Beyondstengthpctp_img,
      icon: null,
    },
    {
      title: 'With Me',
        ...
        <div className="mx-auto max-w-lg text-center">
          <div className="relative w-full">
            ...
            <div className="relative z-30">
             ...
             Personal Trainer | Mindset & Motivation Coach
              </p>
